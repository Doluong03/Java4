...
<div id="carouselExampleIndicators" class="carousel slide">
    ...
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="/BaiTap_war/views/myimages/524_attimg1_origin.jpg" class="d-block w-100 h-50" alt="">
        </div>
        <div class="carousel-item">
            <img src="/BaiTap_war/views/myimages/523_attimg1_origin.jpg" class="d-block w-100 h-50" alt="">
        </div>
        <div class="carousel-item">
            <img src="/BaiTap_war/views/myimages/522_attimg1_origin.jpg" class="d-block w-100 h-50" alt="">
        </div>
    </div>
